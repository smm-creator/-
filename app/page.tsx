...
const DEFAULT_SEEDANCE_PROMPT =
  "Preserve the exact aspect ratio and framing of the input image — do not crop, zoom, or reframe. The entire person must remain fully visible throughout the video.\n\nDuration: 12 seconds. The video has two parts:\n\nPart 1 (first 6 seconds): The person walks straight forward toward the camera. No turning. Camera tracks smoothly from a fixed frontal angle. Medium full-body shot. Stable, no shake. Lighting unchanged.\n\nPart 2 (last 6 seconds): The person turns their back and walks away from the camera. No turning sideways. Camera tracks smoothly from a fixed rear angle. Same medium full-body shot. Stable, no shake. Same lighting and background.\n\nNo distortion. No extra limbs. No face changes. No clothing changes. No scale changes.";
