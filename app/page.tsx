...
const DEFAULT_FRONT_PROMPT =
  "Fashion video, single continuous shot. The model walks forward toward the camera for a few steps. Then the model does a 180-degree turn — rotating in place until their back is fully facing the camera. The video ends with the model standing still with their back to the camera. The last 1 second must show the model completely still, back facing camera. Camera is fixed, no movement. Lighting and background unchanged throughout.";
