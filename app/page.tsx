...
const DEFAULT_FRONT_PROMPT =
  "The person walks naturally and smoothly toward the camera with relaxed, fluid steps — no robotic or stiff movement. The walk is calm and realistic, like a fashion model on a runway. The camera stays fixed, no movement. The lighting, exposure, and colors must stay exactly the same as in the input image — no darkening, no brightening, no color shift. The background stays identical. Full-body medium shot, centered. Smooth natural motion throughout.";

const DEFAULT_BACK_PROMPT =
  "The person walks naturally and smoothly away from the camera with relaxed, fluid steps — no robotic or stiff movement. The walk is calm and realistic, like a fashion model on a runway. The camera stays fixed, no movement. The lighting, exposure, and colors must stay exactly the same as in the input image — no darkening, no brightening, no color shift. The background stays identical. Full-body medium shot, centered. Smooth natural motion throughout.";
